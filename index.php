...
******************************************************************************************************* -->
          ...
          <div class="col-sm-12" id="infoCenterDiv">
            ...
            <div class="chatBubble animated bounceIn">
              <img class="img-responsive" style="margin:0 auto; padding-top:20px; max-width: 50%;" src="img/logo.png" alt="Shmap Logo" />
...
<!-- Begin Table of Contents -->
              ...
              <div class="row">
                ...
                <div class="col-sm-4">
                  ...
                  <h5 class="text-center"><a href="#tabs"><strong class="orangeColor">Intro to the Shmap Tabs</strong></a></h5>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12">       
                    ...
                    <h4 id="shmapIntro">
                      ...
                      <br><br> -->
                      For answers to our frequently asked questions, please <a href="#FAQs" class="boldStyle">scroll down to the FAQs</a>. 
                      <br>
                      <br>
                  ...
                  <li class="list-group-item">
                    ...
                    <div id="links2">
                      <a href="../img/about/1-registration.png" title="Sign-up/Log-in Page" data-gallery>
                        <img class="img-responsive thumbnailPhotoSmall" src="../img/about/1-registration.png">
                      </a> 
                      <a href="../img/about/4-registration.png" title="Register By Email - Sign Up Form" data-gallery>
                        <img class="img-responsive thumbnailPhotoSmall" src="../img/about/4-registration.png" alt="Register By Email - Sign Up Form image" title="Register By Email - Sign Up Form">
                      </a>
                    </div>
                    <div class="clear"></div>
                  </li>
...
-->
              <div class="col-sm-12">
                <ul id="basics" class="list-group">
                  <li class="list-group-item disabled">
                    <h4 class="listHeader scriptFont">
                      <img src="img/about/icons/shmap_logo.png" style="max-width:20px;"> Shmap Basics
                    </h4>
                      ...
                      <div class="row">
                        ...
                        <div id="linksReminderImage" class="col-sm-3">
                          <a href="../img/about/group.png" title="Composing a Group Message" data-gallery>
                            <img class="img-responsive thumbnailPhotoMain" src="../img/about/group.png" alt="Composing a Group Message Screenshot" title="Composing a Group Message" />
                          </a>
                        </div>
                        <div class="clear"></div>                        
                    ...
                    <div class="row">
                      ...
                      <div id="linksReminderImage" class="col-sm-3">
                        <a href="../img/about/reminder.png" title="New Reminder screen" data-gallery>
                          <img class="img-responsive thumbnailPhotoMain" src="../img/about/reminder.png" alt="New Reminder screen screenshot" title="New Reminder screen" />
                        </a>
                      </div>
                      <div class="clear"></div>
                    ...
                    <div class="row">
                      ...
                      <div id="linksContactsImage" class="col-sm-3">
                        <a href="../img/about/16-Contacts.png" title="Contacts Tab" data-gallery>
                          <img class="img-responsive thumbnailPhotoMain" src="../img/about/16-Contacts.png" alt="Contacts Tab" title="Contacts Tab" />
                        </a>
                      </div>
                      <div class="clear"></div>
                    ...
                    <div class="row">
                      ...
                      <div id="linksSettingsTab" class="col-sm-3">
                        <a href="../img/about/24-settings.png" title="Settings Tab" data-gallery>
                          <img class="img-responsive thumbnailPhotoMain" src="../img/about/24-settings.png" alt="Settings Tab Screenshot" title="Settings Tab" />
                        </a>
                      </div>
                      <div class="clear"></div>
